 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |  Grv   |   1  |   2  |   3  |   4  |   5  | ESC  |           |   %  |   6  |   7  |   8  |   9  |   0  | Pwr    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |~L1   | LCtrl| Alt  | LCtrl| LGui |                                       | Left | Right|  Up  | Down | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                      ,---------------.       ,---------------.
 *                                      | Home   | End  |       | Vol- | Vol+   |
 *                               ,------|--------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_FN1,      KC_LCTL,     KC_LALT, KC_LCTL,KC_LGUI,
                                                            KC_HOME, KC_END,
                                                                     KC_HOME,
                                                   KC_BSPC, KC_DEL,  KC_END,
                                                                                // right hand
                                                                                KC_PERC, KC_6, KC_7,    KC_8,    KC_9,        KC_0,          KC_PWR,
                                                                                KC_MINS, KC_Y, KC_U,    KC_I,    KC_O,        KC_P,          KC_BSLS,
                                                                                         KC_H, KC_J,    KC_K,    KC_L,        KC_SCLN,       KC_QUOT,
                                                                                KC_RBRC, KC_N, KC_M,    KC_COMM, KC_DOT,      KC_SLSH,       KC_RSFT,
                                                                                               KC_LEFT, KC_RGHT, KC_UP,       KC_DOWN,       KC_FN1,
                                                                                KC_VOLD, KC_VOLU,
                                                                                KC_PGUP,
